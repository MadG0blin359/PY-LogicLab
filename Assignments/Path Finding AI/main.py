...
class PathfinderPro:
    def __init__(self):
        ...
        self.font_n = pygame.font.SysFont('Consolas', 12) # Font for exploration order
    ...
    def draw_cell(self, r, c, color, number=None, border=False):
        ...
        # Display the exploration order number
    ...
    def gui_callback(self, pos, node_type):
        """Callback to visualize frontier and explored nodes with step count."""
        ...
        if node_type == "explored":
            ...
            color = CLR_FRONT # Frontier nodes don't get a number until explored
    ...
    def render_ui(self, status="READY"):
        ...
        self.exploration_count = 0 # Reset count on UI refresh
